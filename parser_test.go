...
func (s *testParserSuite) TestDDL(c *C) {
	table := []testCase{
		...
		{"create table t (c int) STORAGE DISK", true, "CREATE TABLE `t` (`c` INT) STORAGE DISK /* TableOptionStorageMedia is not supported */ "},
		{"create table t (c int) STORAGE MEMORY", true, "CREATE TABLE `t` (`c` INT) STORAGE MEMORY /* TableOptionStorageMedia is not supported */ "},
