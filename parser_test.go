...
func (s *testParserSuite) TestWindowFunctions(c *C) {
	table := []testCase{
		...
		{`select read_ts_in('2015-09-21 00:07:01', NOW())`, true, "SELECT READ_TS_IN(_UTF8MB4'2015-09-21 00:07:01', NOW())"},
		{`select read_ts_in(DATE_SUB(NOW(), INTERVAL 3 SECOND), NOW())`, true, "SELECT READ_TS_IN(DATE_SUB(NOW(), INTERVAL 3 SECOND), NOW())"},
		{`select read_ts_in('2015-09-21 00:07:01', '2021-04-27 11:26:13')`, true, "SELECT READ_TS_IN(_UTF8MB4'2015-09-21 00:07:01', _UTF8MB4'2021-04-27 11:26:13')"},
...
func (s *testParserSuite) TestAsOfClause(c *C) {
	table := []testCase{
		...
		{"START TRANSACTION READ ONLY AS OF TIMESTAMP READ_TS_IN(_UTF8MB4'2015-09-21 00:07:01', NOW())", true, "START TRANSACTION READ ONLY AS OF TIMESTAMP READ_TS_IN(_UTF8MB4'2015-09-21 00:07:01', NOW())"},
		{"START TRANSACTION READ ONLY AS OF TIMESTAMP READ_TS_IN(DATE_SUB(NOW(), INTERVAL 3 SECOND), NOW())", true, "START TRANSACTION READ ONLY AS OF TIMESTAMP READ_TS_IN(DATE_SUB(NOW(), INTERVAL 3 SECOND), NOW())"},
		{"START TRANSACTION READ ONLY AS OF TIMESTAMP READ_TS_IN(_UTF8MB4'2015-09-21 00:07:01', '2021-04-27 11:26:13')", true, "START TRANSACTION READ ONLY AS OF TIMESTAMP READ_TS_IN(_UTF8MB4'2015-09-21 00:07:01', _UTF8MB4'2021-04-27 11:26:13')"},
	}
	s.RunTest(c, table)
}
