...
'`},
		...
		{"show table t1 regions where a like 'some%'", true, "SHOW TABLE `t1` REGIONS WHERE `a` LIKE 'some%'"},
		{"show table t1", false, ""},
		...
		{"show table t1 index idx1 regions where a like 'some%'", true, "SHOW TABLE `t1` INDEX `idx1` REGIONS WHERE `a` LIKE 'some%'"},
