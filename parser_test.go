...
func (s *testParserSuite) TestBuiltin(c *C) {
	table := []testCase{
		...
		{"SELECT FORMAT_BYTES(18446644073709551615);", true, "SELECT FORMAT_BYTES(18446644073709551615)"},
		{"SELECT FORMAT_NANO_TIME(3501);", true, "SELECT FORMAT_NANO_TIME(3501)"},
		{"SELECT FORMAT_NANO_TIME(188732396662000);", true, "SELECT FORMAT_NANO_TIME(188732396662000)"},
