...
func (s *testParserSuite) TestExplain(c *C) {
	table := []testCase{
		...
		{"EXPLAIN FOR 1", true, "EXPLAIN FORMAT = 'row' FOR 1"},
		{"EXPLAIN FOR 42", true, "EXPLAIN FORMAT = 'row' FOR 42"},
		{"EXPLAIN FORMAT = 'dot' FOR 1", true, "EXPLAIN FORMAT = 'dot' FOR 1"},
		{"EXPLAIN FORMAT = 'row' FOR 1", true, "EXPLAIN FORMAT = 'row' FOR 1"},
	}
	s.RunTest(c, table)
}
