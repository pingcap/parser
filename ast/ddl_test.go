...
func (ts *testDDLSuite) TestDDLVisitorCover(c *C) {
	...
	stmts := []struct {
		...
		{&ReferenceDef{Table: &TableName{}, KeyPartSpecifications: []*KeyPartSpecification{{Column: &ColumnName{}}, {Column: &ColumnName{}}}, OnDelete: &OnDeleteOpt{}, OnUpdate: &OnUpdateOpt{}}, 0, 0},
...
func (ts *testDDLSuite) TestDDLIndexColNameRestore(c *C) {
	...
	extractNodeFunc := func(node Node) Node {
		return node.(*CreateIndexStmt).KeyPartSpecifications[0]
	}
